...
| Elementų valdymas | `push_back()`, `pop_back()`, `insert()`, `erase()`, `clear()`, `resize()`, `reserve()`, `shrink_to_fit()`, `swap()` |
...
| `void swap(Vector& other)` | Apkeičia du vektorius |
...
| `operator==` | Lygina du vektorius elementų požiūriu |
| `operator!=` | Ne lygu |
